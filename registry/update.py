...
from registry.validate import validate_registry
...
def _find_dataset_entry(registry: dict, dataset_slug: str) -> dict:
    ...
    raise RuntimeError(
        f"Dataset slug '{dataset_slug}' was not found in registry datasets."
    )
...
def run(result_path_or_run_dir: str, repo_root: Path | None = None) -> dict:
    ...
    manifest_path = repo_root / "releases" / release_id / "manifest.json"
