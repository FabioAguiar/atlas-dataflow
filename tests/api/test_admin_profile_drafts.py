...
and configure ATLAS_ADMIN_ENABLED and the persistence module's repo_root
...
def test_get_route_returns_absence_for_missing_draft_in_private_runtime_without_token_header():
